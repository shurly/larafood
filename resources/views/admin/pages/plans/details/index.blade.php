...
@section('content_header')
    ...
    <h1>Detalhes do Plano {{$plan->name}}<a href="{{ route('details.plan.create', $plan->url) }}" class="btn btn-dark">Adicionar <i
            ...
            <table class="table table-condensed">
                ...
                @foreach($details as $detail)
                    <tr>
                        ...
                        <td style="width:10px; ">
                            <a href="{{route('details.plan.edit',[ $plan->url, $detail->id])}}" class="btn btn-primary">Editar</a>
