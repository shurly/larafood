...
@section('content_header')
    ...
    <h1>Perfis <a href="{{ route('profiles.create') }}" class="btn btn-dark">Adicionar <i
                ...
                @foreach($profiles as $profile)
                    <tr>
                        ...
                        <td style="width:10px; ">
                            ...
                            <a href="{{route('profiles.plans', $profile->id)}}" class="btn btn-primary"><i class="fas fa-list-alt"></i></a>
                        </td>
