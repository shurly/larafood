...
@section('content_header')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ route('users.index') }}" class="active">Usuário</a></li>
    </ol>

    <h1>Cargos do usuário <strong>{{ $user->name }}</strong></h1>

    <a href="{{ route('users.roles.create', $user->id) }}" class="btn btn-dark">Adicionar</a>
